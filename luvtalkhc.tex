...
\def\subtitle{Or, What I did on my holidays}
\def\theme{CambridgeUS}
\def\mytitle{Humanities computing and Drupal}
...
\part{Unlocking the ivory tower}
\label{unlockingtheivorytower}
...
\begin{frame}
\frametitle{Literary and linguistic applications}
\label{literaryandlinguisticapplications}
...
\begin{frame}
\frametitle{Historical applications}
\label{historicalapplications}
...
\begin{frame}
\frametitle{Using and adapting tools}
\label{usingandadaptingtools}
...
\begin{frame}
\frametitle{Resources and evaluation}
\label{resourcesandevaluation}
...
\texttt{claudine@foundersandsurvivors.org}
